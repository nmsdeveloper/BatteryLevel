  ...
  navigator.getBattery().then((batt) => {
    updateBattery = () => {
      ...
      if (level == 100) {
        ...
        batteryStatus.innerHTML = `Baterie Faible <i class="ri-plug-line animated-red"></i>`;
      else if (batt.charging)
        batteryStatus.innerHTML = `Mise en charge... <i class="ri-flashlight-line animated-green"></i>`;
